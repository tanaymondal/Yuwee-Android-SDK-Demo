...
import com.yuwee.yuweesdkdemo.databinding.FragmentGroupChatBinding;
 ...
 */
public class GroupChatFragment extends Fragment implements ChatListAdapter.OnListItemClickListener, ChatImpl.UpdateCountListener {
    ...
    private FragmentGroupChatBinding viewBinding = null;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        viewBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_group_chat, container, false);
    ...
    public void onListItemClicked(int position) {
        ...
        intent.putExtra(ChatDetailsActivity.IS_GROUP_CHAT, true);
